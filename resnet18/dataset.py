...
class DataSet(object):
    ...
    def __init__(self, database_dir):
        ...
        '''
        self.dataset_name=database_dir
        self.dataset_dir = METADATA_DIR + os.path.sep + database_dir
        self.file_name_csv = METADATA_DIR + os.path.sep + database_dir+'.csv'
        # self.file_name_csv = os.path.sep + database_dir+'.csv'
        self.create_csv()
