...
MODEL_URL_RESNET_101 = 'https://download.pytorch.org/models/resnet101-5d3b4d8f.pth'
MODEL_URL_RESNET_18 = 'https://download.pytorch.org/models/resnet18-5c106cde.pth'

class ResidualNet(ResNet):
    def __init__(self):
        super().__init__(BasicBlock, [2, 2, 2, 2])
        self.load_state_dict(model_zoo.load_url(MODEL_URL_RESNET_18))
