...
DIR='../finetune/output/2022-04-22 11:28:05_mix 300'
MODEL_URL_RESNET_152 = 'https://download.pytorch.org/models/resnet152-b121ed2d.pth'
RESNET152=os.path.join(DIR,'resnet152model_best.pth.tar')
...
class FeatureExtractor(object):
    def __init__(self, dataset):
        ...
        self.res_model.load_state_dict(checkpoint['state_dict'])
        if USE_GPU:
