...
def divide_index_class(source, class_dir):
    ...
    testing_set = shuffled_set[:testing_length]
    val_set=shuffled_set[testing_length:testing_length+val_length]
    train_set = shuffled_set[2*testing_length:]

    shuffled_set2=shuffled_set[testing_length:]

    shuffled_set3 = random.sample(shuffled_set2, len(shuffled_set2))
    index_set=shuffled_set3[:2*testing_length]
