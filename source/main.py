...
if __name__ == "__main__":
    ...
    if args.mode == 'train':
        ...
        if args.model == 'resnet':
            ...
            vlad_class = VladPrediction(vlad_dataset, args.dataset, args.query)
            test_vlad_class=VladPrediction(test_dataset, args.test_dataset, args.query)
            if args.method =='one':
                calculate_map_vlad_metric(vlad_dataset, test_dataset,vlad_class,test_vlad_class,args.distance)
            else:
        ...
        if args.model == 'resnet':
            ...
            vlad_vectors = save_three_nearest_photo_vlad(vlad_class, vlad_dataset, args.query)
